...
*   **Rol 1: Analista de Sistemas / Project Manager (Gestión de Procesos):** Defensa de la problemática de la heladeria, justificación de la metodología ágil **XP**, levantamiento de Historias de Usuario, gestión del tiempo y viabilidad del desarrollo remoto.
